...
def get_data(start_date = dt.datetime(2021,10,7,10,0,0), currency = "BTCUSDT", interval = binance.client.Client.KLINE_INTERVAL_1MINUTE):
    client = BinanceClient(interval)
